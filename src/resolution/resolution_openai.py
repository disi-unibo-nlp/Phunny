...
if __name__ == "__main__":
    ...
    logging.basicConfig(level=logging.DEBUG,
                        ...
                        filename=f"out/resolution/{MODEL_NAME}/{args.mode}/{output_dir}/completions.log",
                        filemode='w')
...
{pun}"""
        ...
        output_file = f'out/resolution/{MODEL_NAME}/{args.mode}/{output_dir}/completions.jsonl'
