...
<p align="center">
  <img src="images/res_comprehension.png" alt="Comprehension Results" style="width: 10vw; height: 10vw; min-width: 150px; min-height: 150px; max-width: 200px; max-height: 200px; margin: 10px;">
  <img src="images/res_resolution.png" alt="Resolution Results" style="width: 10vw; height: 10vw; min-width: 100px; min-height: 100px; max-width: 150px; max-height: 150px; margin: 10px;">
  <img src="images/res_generation.png" alt="Generation Results" style="width: 10vw; height: 10vw; min-width: 100px; min-height: 100px; max-width: 150px; max-height: 150px; margin: 10px;">
</p>
